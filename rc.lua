...
beautiful.init("/home/dmitry/.config/awesome/themes/myTheme/theme.lua")
...
vicious.register(wifiwidget, vicious.widgets.wifi, '<span color="#7F9F7F">${ssid}</span>@<span color="#7F9F7F">${linp}%</span> ', 2, "wlp1s0")
...
globalkeys = awful.util.table.join(
	awful.key({ }, key_Caps_Lock, function () kbdcfg.switch() end),
    --awful.key({ modkey          }, "9", function () pomodoro:toggle() end),
    --awful.key({ modkey, "Shift" }, "0", function () pomodoro:finish() end),
